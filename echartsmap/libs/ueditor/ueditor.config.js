...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            //     'splittocells', 'splittorows', 'splittocols',// 插入表格
            //     'fullscreen' //全屏
            // ]
        ...
        ,'paragraph':{'p':'正文', 'h1':'一级标题', 'h2':'二级标题', 'h3':'三级标题'}
		...
		,whitList: {
			...
			hr:     [],
			i:      ['class', 'style'],
            // 增加_url白名单，修复视频插入丢url问题 by mengcy 2017.10.24
			...
			u:      [],
			ul:     ['class', 'style'],
			video:  ['autoplay', 'controls', 'loop', 'preload', 'src', 'height', 'width', 'class', 'style','data-setup','webkit-playsinline','playsinline'],
            // 新增白名单，修复视频插入丢url问题 by mengcy 2017.10.24
            source: ['src', 'type'],
